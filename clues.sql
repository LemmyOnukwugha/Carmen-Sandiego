...
-- -- Write SQL query here
SELECT language
FROM countrylanguage WHERE countrycode = 'VAT' ;
...
-- Write SQL query here
SELECT name, code, region, language, isofficial, percentage
FROM country 
...
-- -- Write SQL query here
SELECT country.name, city.name, continent
FROM city
